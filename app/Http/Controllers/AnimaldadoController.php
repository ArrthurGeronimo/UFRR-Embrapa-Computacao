...
class AnimaldadoController extends Controller
{
    ...
    {
        $this->validate($request, ['animal_id' => 'required', 'amostra_id' => 'required', 'data' => 'required', 'nome_dado' => 'required', 'unidade' => 'required', 'peso' => 'required', ]);
