...
class OperacaoController extends Controller
{
    ...
    {
        $this->validate($request, ['servico_id' => 'required', 'piquete_id' => 'required', 'insumo_id' => 'required', 'data' => 'required', 'unidade' => 'required', 'quantidade' => 'required', 'valor_unitario' => 'required', ]);
