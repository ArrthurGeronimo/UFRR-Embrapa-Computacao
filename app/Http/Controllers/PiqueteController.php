...
class PiqueteController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('backEnd.piquete.index', compact('piquete'));
    }
    ...
    {
        return view('backEnd.piquete.create');
    }
    ...
    public function show($id)
    {
        ...
        return view('backEnd.piquete.show', compact('piquete'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('backEnd.piquete.edit', compact('piquete'));
    }
