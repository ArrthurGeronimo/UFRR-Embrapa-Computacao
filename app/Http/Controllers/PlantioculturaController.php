...
class PlantioculturaController extends Controller
{
    ...
    {
        $this->validate($request, ['piquete_id' => 'required', 'amostra_id' => 'required', 'data_amostra' => 'required', 'peso_parcela' => 'required', 'peso_amostra' => 'required', 'quantidade_espigas' => 'required', ]);
        ...
        return redirect('plantiocultura');
    }
