...
@section('content')
    ...
    <div class="table table-responsive">
        <table class="table table-bordered table-striped table-hover" id="tblanimaldado">
            <thead>
                <tr>
                    <th>ID</th><th>Animal Id</th><th>Amostra Id</th><th>Data</th><th>Actions</th>
                </tr>
            </thead>
            <tbody>
            @foreach($animaldado as $item)
                <tr>
                    <td>{{ $item->id }}</td>
                    <td><a href="{{ url('animaldado', $item->id) }}">{{ $item->animal_id }}</a></td><td>{{ $item->amostra_id }}</td><td>{{ $item->data }}</td>
                    <td>
